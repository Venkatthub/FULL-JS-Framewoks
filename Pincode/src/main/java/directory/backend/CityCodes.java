...
public class CityCodes {
	...
	private static TreeMap<String, Integer> pinCodes = new TreeMap<>();

//	Method contains codes on each local in chennai city
	public static Map<String, Integer> chennaiCodes() {
	...
	public static List<String> getAreas(int code) {

		return pinCodes.keySet().stream().filter(key -> pinCodes.get(key) == code).collect(Collectors.toList());
